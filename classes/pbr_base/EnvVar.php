			...
			case "get_add_mod_form":
				$return = array(
					...
					<form id="env_var_form">
						<div class="padder no_top center">
							<input type="text" name="content" value="' . $vars['active_env_var']->m_content . '" class="input text_input normal_font center input_clear text_long" clear_if="">
							<input type="hidden" name="title" value="' . $vars['active_env_var']->m_title . '"/>
						</div>
					</form>
						 
					<div class="padder">
						<a href="#" id="env_var" action="' . $vars['action'] . '" env_var_id="' . $vars['active_env_var']->m_env_var_id . '">
